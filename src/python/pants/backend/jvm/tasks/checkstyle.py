...
from pants.option.custom_types import dict_with_files_option, file_contents_option
...
class Checkstyle(NailgunTask):
  ...
  def register_options(cls, register):
    ...
    register('--configuration', advanced=True, type=file_contents_option, fingerprint=True,
