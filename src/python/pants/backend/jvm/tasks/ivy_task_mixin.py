...
class IvyTaskMixin(object):
  ...
  def ivy_resolve(self,
    ...
    :returns: the resulting classpath, the list of JarLibraries used for the resolve, and
    the unique part of the name used for the resolution report (a hash). Also populates
    ...
    with IvyUtils.cachepath(target_classpath_file) as classpath:
      ...
      return (stripped_classpath, global_vts.targets, resolve_hash_name)
