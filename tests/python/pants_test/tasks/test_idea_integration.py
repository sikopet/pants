...
class IdeaIntegrationTest(PantsRunIntegrationTest):
  ...
  def test_idea_external_javadoc_and_sources(self):
    ...
    self._idea_test(['examples/src/java/com/pants/examples/annotation::'],
                    check_func=do_check)
    self._idea_test(['examples/src/java/com/pants/examples/annotation::', '--idea-no-source_jars'],
                    check_func=do_check_no_sources)
    self._idea_test(['examples/src/java/com/pants/examples/annotation::', '--idea-no-javadoc_jars'],
