 ...
 *<p>
 * Exercises the junit runner PARALLEL_BOTH concurrency strategy.
 * <p>
 * For all methods in ParallelMethodsParallelBothTest1 and ParallelBothDefaultParallelTest2
 * to succeed all of the test methods must be running at the same time. Intended to test the flags
 * <p>
 * -default-concurrence PARALLEL_BOTH -parallel-threads 4
 * <p>
