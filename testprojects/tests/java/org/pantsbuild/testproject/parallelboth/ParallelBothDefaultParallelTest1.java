 ...
 * <p>
 * For all methods in ParallelBothParallelBothTest1 and ParallelBothParallelBothTest2
 * to succeed all of the test methods must be running at the same time. Also, both classes must
 * be running at the same time.  Intended to test the flags:
 * <pre>
 ...
 */
public class ParallelBothDefaultParallelTest1 {
